...
class BedrockCosmeticsFormTest {
    ...
    void serializedNativeButtonsDispatchTheSameActionsAsJavaIncludingPreviews() throws Exception {
        ...
        assertEquals(9, json.getAsJsonArray("buttons").size());
        ...
        assertEquals(javaActions, received.subList(0, 7));
        assertEquals(CosmeticMenuAction.Kind.PREVIEW_EMOTE, received.get(7).kind());
        assertEquals(CosmeticMenuAction.Kind.PREVIEW_VICTORY, received.get(8).kind());
    }
