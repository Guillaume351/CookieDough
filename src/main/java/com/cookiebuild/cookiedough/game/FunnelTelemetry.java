...
public final class FunnelTelemetry {
    public enum Event {
        ...
        MATCH_STARTED, MATCH_COMPLETED, MATCH_RECONNECTED, SPECTATOR_JOINED,
        QUEUE_INVITE_SHOWN, REMATCH_CLICKED, DISCONNECTED, KICKED,
        ...
        SKYBLOCK_DEPOSIT_COMPLETED, SKYBLOCK_WITHDRAWAL_COMPLETED,
        SKYBLOCK_NPC_PURCHASED, SKYBLOCK_NPC_SOLD,
        SKYBLOCK_MARKET_LISTING_CREATED, SKYBLOCK_MARKET_PURCHASED, SKYBLOCK_MARKET_CANCELLED,
        SKYBLOCK_WORKER_UPGRADED, SKYBLOCK_COLLECTION_LEVEL_UP,
        SKYBLOCK_DAILY_COMPLETED, SKYBLOCK_WEEKLY_COMPLETED,
        SKYBLOCK_BANK_DEPOSITED, SKYBLOCK_BANK_WITHDRAWN, SKYBLOCK_ISLAND_VISITED,
        SKYBLOCK_ISLAND_LIKED, SKYBLOCK_VISIBILITY_CHANGED, SKYBLOCK_COOP_LEFT,
        SKYBLOCK_OWNERSHIP_TRANSFERRED
    }
